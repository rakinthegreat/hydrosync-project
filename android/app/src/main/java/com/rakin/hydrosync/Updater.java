...
public class Updater {
    private static final String TAG = "HydroSyncUpdater";
    private static final String GITHUB_API_URL = "https://api.github.com/repos/rakinthegreat/hydrosync-project/releases/latest";
    ...
    private static void showUpdateDialog(final Context context, String current, String latest, String url) {
        ...
        new MaterialAlertDialogBuilder(themedContext)
                ...
                .setMessage("HydroSync " + latest + " is ready.\nYou're on version " + current + ".")
